...
export const Navbar = () => {
  return (
    <nav className="bg-gray-600 w-full h-16">
      <div className="container mx-auto flex flex-row items-center gap-5 px-5 h-full">
        <div className="w-9 h-9 rounded-full flex items-center justify-center bg-green-400">L</div>
        <h1 className="shrink w-full text-2xl font-medium font-roboto">YouTube Past</h1>
        <span className="whitespace-nowrap font-thin text-xs font-roboto ">32 months</span>
      </div>
    </nav>
  );
};
